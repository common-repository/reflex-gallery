    ...
    <table class="widefat post fixed" id="galleryResults" cellspacing="0">
     ...
     <table class="widefat post fixed" cellspacing="0">
        ...
        <tbody>
			...
			<tr>
            	<td><?php _e('Thumbnail Fade Style', 'reflex-gallery'); ?></td>
                <td>
					<select id="style" name="style">
						<option value="none"<?php _e(($default_options[1]['style'] == 'none') ? " selected" : ""); ?>>None</option>
     ...
     <table class="widefat post fixed">
    	<thead>
        <tr>
        	<th><em>Other plugins by <a href="https://labs.hahncreativegroup.com/wordpress-plugins/" target="_blank">HahnCreativeGroup</a></em></th>
        </tr>
        </thead>
        <tfoot>
        <tr>
        ...
        <tbody>        				
            ...
            <td>
            	<ul>
                    <li><a href="https://labs.hahncreativegroup.com/wordpress-plugins/wp-easy-gallery-pro-simple-wordpress-gallery-plugin/?src=rg" target="_blank">WP Easy Gallery Pro</a></li>
                    <li><a href="https://wordpress.org/extend/plugins/custom-post-donations/" target="_blank">Custom Post Donations</a></li>
                    <li><a href="https://wordpress.org/extend/plugins/wp-translate/" target="_blank">WP Translate</a></li>
                </ul>
            </td>            
            </tr>
            </tbody>
